...
Public Class AxisRates
    ...
    '
    Friend Sub New(ByVal Axis As TelescopeAxes, _FastRate As Double, SkySafari As Single)
        m_Axis = Axis
        '
        ...
        Select Case Axis
            Case TelescopeAxes.axisPrimary
                ReDim m_Rates(4)
                m_Rates(0) = New Rate(_FastRate, _FastRate)  'SLEW - dynamic max rate from mount
                ...
                If SkySafari = 1 Then
                    m_Rates(4) = New Rate(0.0000, 0.00) 'No variable rates for Sky Safari
                Else
                    m_Rates(4) = New Rate(0.00, _FastRate) 'variable rate for apps
                End If
